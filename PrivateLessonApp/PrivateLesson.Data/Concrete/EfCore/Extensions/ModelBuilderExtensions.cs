...
namespace PrivateLesson.Data.Concrete.EfCore.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            {
                //Admin
                new User {FirstName="Ahmet", LastName="Ovalı", UserName="ahmet", NormalizedUserName="AHMET", Email="ahmet@hotmail.com", NormalizedEmail="AHMET@HOTMAIL.COM", Gender="Erkek", DateOfBirth= new DateTime(1998,5,15), City="İstanbul",Phone = "5555555555",EmailConfirmed=true,ImageId = 5},
                //Students
                    
                new User {FirstName="Deniz", LastName="Çakır", UserName="denizcakir", NormalizedUserName="DENIZCAKIR", Email="denizcakir@hotmail.com", NormalizedEmail="DENIZCAKIR@HOTMAIL.COM", Gender="Kadın", DateOfBirth= new DateTime(2007,5,18), City="İstanbul",Phone = "5396542513",EmailConfirmed=true,ImageId = 5 },

                new User {FirstName="Ahmet", LastName="Yılmaz", UserName="ahmetyilmaz", NormalizedUserName="AHMETYILMAZ", Email="ahmetyilmaz@gmail.com", NormalizedEmail="AHMETYILMAZ@GMAİL.COM", Gender="Erkek", DateOfBirth= new DateTime(2002,5,8), City="Ankara",Phone = "5551234567",EmailConfirmed=true,ImageId = 5},
                ...
                new User {FirstName="Cem", LastName="Yılmaz", UserName="cemyilmaz", NormalizedUserName="CEMYILMAZ", Email="cem.yilmaz@gmail.com", NormalizedEmail="CEM.YILMAZ@GMAIL.COM", Gender="Erkek", DateOfBirth= new DateTime(1990,2,27), City="Ankara",Phone = "5323456789",EmailConfirmed=true, ImageId = 2},

                new User {FirstName="Şevval", LastName="Demir", UserName="sevvaldemir", NormalizedUserName="SEVVALDEMIR", Email="esraaydin@hotmail.com", NormalizedEmail="sevval.demir@hotmail.com", Gender="Kadın", DateOfBirth= new DateTime(1992,9,2), City="İstanbul",Phone = "5387891234",EmailConfirmed=true, ImageId=3},

                new User {FirstName="Mehmet", LastName="Yıldız", UserName="mehmetyildiz", NormalizedUserName="MEHMETYILDIZ", Email="mehmet.yildiz@gmail.com", NormalizedEmail="MEHMET.YILDIZ@GMAIL.COM", Gender="Erkek", DateOfBirth= new DateTime(1994,10,26), City="İzmir",Phone = "5336549876",EmailConfirmed=true, ImageId=4},

                new User {FirstName="Gül", LastName="Şahin", UserName="gulsahin", NormalizedUserName="GULSAHIN", Email="gul.sahin@hotmail.com", NormalizedEmail="GUL.SAHIN@HOTMAIL.COM", Gender="Kadın", DateOfBirth= new DateTime(1980,12,4), City="Antalya",Phone = "5361234567",EmailConfirmed=true, ImageId=5},

                 new User {FirstName="Kemal", LastName="Kaya", UserName="kemalkaya", NormalizedUserName="KEMALKAYA", Email="kemal.kaya@gmail.com", NormalizedEmail="KEMAL.KAYA@GMAIL.COM", Gender="Erkek", DateOfBirth= new DateTime(1987,5,25), City="Kayseri",Phone = "5359876543",EmailConfirmed=true, ImageId=5},

                new User {FirstName="Gökhan", LastName="Aydın", UserName="gokhanaydin", NormalizedUserName="GOKHANAYDIN", Email="gokhan.aydin@gmail.com", NormalizedEmail="GOKHAN.AYDIN@GMAIL.COM", Gender="Erkek", DateOfBirth= new DateTime(1990,3,17), City="Adana",Phone = "5321234567",EmailConfirmed=true, ImageId=5},

                new User {FirstName="Şeyma", LastName="Yılmaz", UserName="seymayilmaz", NormalizedUserName="SEYMAYILMAZ", Email="seyma.yilmaz@hotmail.com", NormalizedEmail="SEYMA.YILMAZ@HOTMAIL.COM", Gender="Kadın", DateOfBirth= new DateTime(1992,11,7), City="Bursa",Phone = "5399876543",EmailConfirmed=true, ImageId=5}
            };
